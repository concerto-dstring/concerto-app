...
class ForgetPassword extends Component {
  ...
  render() {
    const {
      isLoading,
      isNext,
      userNameCodeBorderColor,
      userNameCodeErrorMsg,
      passwordBorderColor,
      passwordErrorMsg,
      confirmPasswordBorderColor,
      confirmPasswordErrorMsg,
      validateCodeBorderColor,
      validateCodeErrorMsg,
    } = this.state;
          ...
          <div className="forget_body_component">
            ...
            {isNext ? (
              <>
                <br />
                <div className="forget_item">
                  <span className="forget_label">
                    <span className="forget_required">*</span> 新密码：
                  </span>
                  <Input.Password
                ...
                <div className="forget_item">
                  <span className="forget_label">
                    <span className="forget_required">*</span> 确认新密码：
                  </span>
                  <Input.Password
                ...
                <div className="forget_forget_item">
                  <div className="forget_link_left">
                    <Button onClick={this.reSendValidateCode}>重新发送验证码</Button>
                  </div>
                  <div className="forget_link_right">
                    <Button type="primary" onClick={this.confirmUpdatePassword}>
                      确认重置密码
                    </Button>
                  </div>
                </div>
              ...
              <>
                ...
                <br />
                <div className="forget_item">
                  <Button style={{width: 360, borderRadius: 12}} type="primary" onClick={this.goToNextStep}>
                    下一步
                  </Button>
                </div>
              </>
